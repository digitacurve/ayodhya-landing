  ...
  return (
    <html lang="en" className={`${playfair.variable} ${inter.variable}`}>
      ...
      <head>
        ...
        <noscript>
          <img
            ...
            width="1"
            style={{ display: "none" }}
            src="https://www.facebook.com/tr?id=3438031989704018&ev=PageView&noscript=1"
          />
        </noscript>
      </head>
      ...
      <body className="font-inter bg-sacred-cream overflow-x-hidden">
        ...
        <noscript>
          <iframe
            src="https://www.googletagmanager.com/ns.html?id=GTM-WM5MZTCH"
            height="0"
            width="0"
...
})(window,document,'script','dataLayer','GTM-WM5MZTCH');`,
          }}
        />
      </body>
    </html>
