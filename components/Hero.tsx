          ...
          >
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-3 sm:gap-4 max-w-lg mx-auto mb-6">
              ...
              <a
                ...
                className="flex items-center gap-2 border border-emerald-500/40 hover:border-emerald-500/80 text-emerald-400 px-6 py-3.5 rounded-full font-semibold text-[14px] sm:text-base backdrop-blur-sm hover:bg-emerald-500/[0.05] transition-all duration-300 w-full justify-center"
                data-cta="whatsapp"
                data-source="hero-slide"
              >
                <WhatsAppIcon />
