...
const trustBadges = [
  ...
  { icon: CheckCircle2, label: "No Advance Payment",   sub: "Pay only on confirm" },
];
    ...
    >
      ...
      >
        ...
        >
          ...
          <span className="text-saffron-400 font-playfair font-bold text-2xl leading-none">₹6,999</span>
