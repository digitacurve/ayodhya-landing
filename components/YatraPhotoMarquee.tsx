...
const marqueeItems: MarqueeItem[] = [
  ...
  { id: 7, src: "/gallery/gallery-15.jpg", location: "Varanasi Ghats", tag: "Kashi Yatra", caption: "Devotees standing at the Ganga River ghats platform." },
  { id: 8, src: "/gallery/gallery-18.jpg", location: "Triveni Sangam", tag: "Prayagraj", caption: "Family group standing by the holy Triveni Sangam." },
  { id: 9, src: "/gallery/gallery-19.jpg", location: "Varanasi", tag: "Ganga Boat Ride", caption: "Pilgrims in life jackets during the Kashi Ganga boat ride." },
  { id: 10, src: "/gallery/gallery-20.jpg", location: "Ayodhya Dham", tag: "Tempo Traveller", caption: "A group of pilgrims next to their luxury private coach." },
  { id: 11, src: "/gallery/gallery-25.jpg", location: "Varanasi", tag: "Ganga Ghats", caption: "Devotees group posing next to the holy Ganga river at Varanasi." },
  { id: 12, src: "/gallery/gallery-26.jpg", location: "Varanasi Airport", tag: "Arrival", caption: "Family standing together at Lal Bahadur Shastri Airport, Babatpur." },
  { id: 13, src: "/gallery/gallery-27.jpg", location: "Ayodhya Dham", tag: "Temple Gate", caption: "A family group posing in front of the main temple entrance gate." },
  { id: 14, src: "/gallery/gallery-28.jpg", location: "Triveni Sangam", tag: "Prayagraj", caption: "Family group standing next to the holy Ganga river at Sangam." },
  { id: 15, src: "/gallery/gallery-30.jpg", location: "Ayodhya Dham", tag: "Luxury Coach", caption: "Pilgrims wearing saffron stoles posing with the luxury tour coach." },
];
