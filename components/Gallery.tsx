...
const galleryItems: GalleryItem[] = [
  ...
  { id: 8, src: "/gallery/gallery-8.jpg", location: "Ayodhya Dham", tag: "Ram Mandir Sanctum", caption: "A devotee offering prayers inside the temple." },
  { id: 9, src: "/gallery/gallery-9.jpg", location: "Ayodhya Dham", tag: "Ram Lalla Darshan", caption: "Young devotee fold hands in front of Ram Lalla." },
  { id: 10, src: "/gallery/gallery-10.jpg", location: "Ayodhya Dham", tag: "Family Group", caption: "A large family posing on the steps of the sacred temple." },
  { id: 11, src: "/gallery/gallery-11.jpg", location: "Ayodhya Dham", tag: "Temple Entrance", caption: "Pilgrims gathering at the main entrance gate of the temple." },
  { id: 12, src: "/gallery/gallery-12.jpg", location: "Ayodhya Dham", tag: "Women Devotees", caption: "Group of women devotees wearing matching yellow/white sarees." },
  { id: 13, src: "/gallery/gallery-13.jpg", location: "Ayodhya Dham", tag: "Night Darshan", caption: "A large group of devotees in front of the illuminated gate at night." },
  { id: 14, src: "/gallery/gallery-14.jpg", location: "Hotel Lobby", tag: "Yatra Prasadam", caption: "A family holding gift boxes after checking into their premium hotel." },
  { id: 15, src: "/gallery/gallery-15.jpg", location: "Varanasi Ghats", tag: "Kashi Yatra", caption: "Devotees standing at the Ganga River ghats platform." },
  { id: 16, src: "/gallery/gallery-16.jpg", location: "Varanasi Airport", tag: "Arrival", caption: "Family next to their private tourist van at Varanasi Airport." },
  { id: 17, src: "/gallery/gallery-17.jpg", location: "Ayodhya Dham", tag: "Ram Mandir Gate", caption: "Devotees group holding prayer items in front of the temple gate." },
  { id: 18, src: "/gallery/gallery-18.jpg", location: "Triveni Sangam", tag: "Prayagraj", caption: "Family group standing by the holy Triveni Sangam." },
  { id: 19, src: "/gallery/gallery-19.jpg", location: "Varanasi", tag: "Ganga Boat Ride", caption: "Pilgrims in life jackets during the Kashi Ganga boat ride." },
  { id: 20, src: "/gallery/gallery-20.jpg", location: "Ayodhya Dham", tag: "Tempo Traveller", caption: "A group of pilgrims in saffron stoles next to their luxury private vehicle." },
  { id: 21, src: "/gallery/gallery-21.jpg", location: "Ayodhya Dham", tag: "Ram Mandir", caption: "Pilgrims in saffron stoles standing at the temple gates." },
  { id: 22, src: "/gallery/gallery-22.jpg", location: "Ayodhya Dham", tag: "Ram Mandir Front", caption: "Devotees chanting and posing at the newly built Ram Mandir." },
  { id: 23, src: "/gallery/gallery-23.jpg", location: "Varanasi", tag: "Kashi Ghats", caption: "Large group posing at night at the Dashashwamedh Ghat gate." },
  { id: 24, src: "/gallery/gallery-24.jpg", location: "Hotel Lobby", tag: "Varanasi Yatra", caption: "Devotees holding prasadam box after Kashi Darshan." },
  { id: 25, src: "/gallery/gallery-25.jpg", location: "Varanasi", tag: "Ganga Ghats", caption: "Devotees group posing next to the holy Ganga river at Varanasi." },
  { id: 26, src: "/gallery/gallery-26.jpg", location: "Varanasi Airport", tag: "Arrival", caption: "Family standing together at Lal Bahadur Shastri Airport, Babatpur." },
  { id: 27, src: "/gallery/gallery-27.jpg", location: "Ayodhya Dham", tag: "Temple Entrance", caption: "A family group posing in front of the main temple entrance gate." },
  { id: 28, src: "/gallery/gallery-28.jpg", location: "Triveni Sangam", tag: "Prayagraj", caption: "Family group standing next to the holy Ganga river at Sangam." },
  { id: 29, src: "/gallery/gallery-29.jpg", location: "Varanasi", tag: "Ganga Boat Ride", caption: "Devotees sitting inside a boat on the Ganga river." },
  { id: 30, src: "/gallery/gallery-30.jpg", location: "Ayodhya Dham", tag: "Luxury Tempo", caption: "Pilgrims wearing saffron stoles posing with the luxury tour coach." },
];
